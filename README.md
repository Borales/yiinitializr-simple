YIInitializr-simple
=======
The following is a proposed project structure for simple applications that works in conjunction with YIInitializr components.
...
The following extensions are part of YIInitializr-simple template:
